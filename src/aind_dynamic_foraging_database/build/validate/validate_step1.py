...
from aind_dynamic_foraging_database.build import nwb_reader_legacy, parquet_builder
...
def main(cache_only=False):
    ...
    if cache_only:
        from aind_dynamic_foraging_database.build.validate import plot_validation
